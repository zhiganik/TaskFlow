...
public class WorkspaceMembersServiceTests
{
    ...
    public void SetUp()
    {
        ...
        _workspacesRepositoryMock
            ...
            .ReturnsAsync(new Workspace { Id = WorkspaceId, Name = "Test Workspace" });
    ...
    public async Task UpdateRoleAsync_NotMember_ThrowsNotFoundException()
    {
        ...
        var act = async () => await _sut.UpdateRoleAsync(
            WorkspaceId, "user-2", new UpdateMemberRoleRequest(WorkspaceRole.Admin), "admin-1", CancellationToken.None);
    ...
    public async Task UpdateRoleAsync_TargetIsOwner_ThrowsConflictException()
    {
        ...
        var act = async () => await _sut.UpdateRoleAsync(
            WorkspaceId, "owner-1", new UpdateMemberRoleRequest(WorkspaceRole.Admin), "admin-1", CancellationToken.None);
    ...
    public async Task UpdateRoleAsync_ValidRequest_UpdatesRoleAndReturnsDto()
    {
        ...
        var result = await _sut.UpdateRoleAsync(
            WorkspaceId, user.Id, new UpdateMemberRoleRequest(WorkspaceRole.Admin), "admin-1", CancellationToken.None);
    ...
    public async Task RemoveAsync_NotMember_ThrowsNotFoundException()
    {
        ...
        var act = async () => await _sut.RemoveAsync(WorkspaceId, "user-2", "admin-1", CancellationToken.None);
    ...
    public async Task RemoveAsync_TargetIsOwner_ThrowsConflictException()
    {
        ...
        var act = async () => await _sut.RemoveAsync(WorkspaceId, "owner-1", "admin-1", CancellationToken.None);
    ...
    public async Task RemoveAsync_ValidRequest_RemovesMember()
    {
        ...
        await _sut.RemoveAsync(WorkspaceId, user.Id, "admin-1", CancellationToken.None);
